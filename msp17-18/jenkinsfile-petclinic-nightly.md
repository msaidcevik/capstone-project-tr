...
```
    - echo "Kubernetes Master is not UP and running yet." kısmındaki env.id ile oluşturulan key_pairin 
    public kısmı alınıyor.
    - post --> always işlem başarı olsada olmasada altdaki silme işlemlerini yapacak.
